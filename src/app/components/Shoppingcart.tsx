...
import product1img from "../assets/Product Image1.png"
import product1img2 from "../assets/Product Image2.png"
...
const Shoppingcart = () => {
  return (
    ...
    <h1 className="font-clash font-normal sm:text-[36px] sm:leading-[50.4px]  text-[24px] leading-[33.6px]  text-[#2A254B]">Your shopping cart</h1>
    ...
    <div className="flex flex-col sm:gap-[20px] mt-[40px] sm:mb-[0px]  ">
        {itemdata.map((elem, id)=>{
            return(
                <CartItems key={id} image={elem.image} title={elem.title} description={elem.description} price={elem.price}   />
            )
        })}
    </div>
    ...
    <button className="bg-[#2A254B] px-[32px] py-[16px] sm:w-auto w-[342px]  flex justify-center">
